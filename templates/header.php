...
<form action="search.php" method="POST">
    ...
    <nav class="filterNav">
        <ul>
        <li><a href="index.php?filter=Running Shoes">Running Shoes</a></li>
            <li><a href="index.php?filter=Shorts">Shorts</a></li>
            <li><a href="index.php?filter=Sports Bras">Sports Bras</a></li>
